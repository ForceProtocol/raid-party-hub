	...
	async getGames(req, res) {
		try {
			...
			games = _.map(games, function(game){
				return {game_id:game.gameId,title:game.title,reward:game.rewardAvailable,description:game.description,jackpot:jackpot,bannerContent:bannerContent,link:game.link,platform:game.platform,avatar:game.avatar};
			});
