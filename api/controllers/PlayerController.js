		...
		try {
			...
			if (locale == 'es' || locale == 'es_ES' || locale == 'es-MX') {
				...
				msg = `�Bienvenido a RaidParty! <br /> 
					Tu cuenta ha sido creada. Descargue la <a href="https://play.google.com/store/apps/details?id=com.app.Raidparty">aplicaci�n m�vil RaidParty aqu�</a> para usuarios de Android e inicie sesi�n con su correo electr�nico y contrase�a creada. 
					<br />
					Si tiene un dispositivo con iOS, espere hasta que nuestro equipo lance la versi�n de iOS de la aplicaci�n. <br />
					Recuerde tambi�n ingresar su propia identificaci�n de jugador de 7 caracteres en la configuraci�n del juego, que encontrar� en la p�gina de la lista de juegos en la aplicaci�n m�vil. <br />
					Esto es importante para poder rastrear la actividad de tu juego. <br /> <br />
					El equipo de �xito de RaidParty`;
			} else if (locale == 'pt' || locale == 'pt_PT' || locale == 'pt-BR') {
				subject = "Bem vindo a RaidParty! Ative a sua conta e come�e a ganhar recompensas ";
				msg = `Bem-vindo ao RaidParty! <br />
						Sua conta foi criada. Fa�a o download do <a href="https://play.google.com/store/apps/details?id=com.app.Raidparty">aplicativo m�vel RaidParty aqui</a> para usu�rios do Android e fa�a login usando seu e-mail e senha criada. <br />
						Se voc� tiver um dispositivo iOS, aguarde at� que nossa equipe libere a vers�o iOS do aplicativo. <br />
						Lembre-se tamb�m de inserir seu pr�prio ID de 7 caracteres exclusivo nas configura��es do jogo, que voc� encontrar� na p�gina da lista de jogos no aplicativo m�vel. <br />
						Isso � importante para que sua atividade no jogo possa ser rastreada. <br /> <br />
